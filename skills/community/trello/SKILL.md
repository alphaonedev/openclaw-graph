...
name: trello
cluster: community
description: "Trello: boards, lists, cards, labels, checklists, power-ups, webhooks, Butler automation"
tags: ["trello", "kanban", "boards", "project"]
dependencies: []
composes: []
similar_to: []
...
## Purpose
Trello: boards, lists, cards, labels, checklists, power-ups, webhooks, Butler automation
...
## When to Use
- When the task requires trello capabilities
