...
cluster: community
description: "macOS Reminders: create tasks, due dates, priorities, lists, location-based, iCloud sync"
tags: ["reminders", "macos", "tasks", "apple"]
dependencies: []
composes: []
similar_to: []
...
## When to Use
- When the task requires apple reminders capabilities
