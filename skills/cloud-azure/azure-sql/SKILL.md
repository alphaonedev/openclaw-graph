...
name: azure-sql
cluster: cloud-azure
description: "Operate Azure SQL Database, Cosmos DB, and managed database services."
tags: ["azure-sql","cosmos-db","database"] 
dependencies: []
composes: []
similar_to: []
called_by: []
...
embedding_hint: "Operate Azure SQL Database, Cosmos DB, and managed database services."
---
